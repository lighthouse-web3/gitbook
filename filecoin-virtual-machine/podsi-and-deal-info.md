...
````
// Some code
You can get podsi and deal information of file using get_proof api
ex: https://api.lighthouse.storage/api/lighthouse/get_proof?cid=QmS7Do1mDZNBJAVyE8N9r6wYMdg27LiSj5W9mmm9TZoeWp&network=testnet
...
Here,
pieceCID and pieceSize are pieceCid, pieceCID of aggregated file that goes for deal

Proof contain data that can be used to verify if you file was part of given aggregate

dealInfo is the deal Information of file, dealId null imply deal is initiated but miner is yet to start sealing

previousAggregates if deal of file is renewed, older aggregateID of given file is present in this parameter
