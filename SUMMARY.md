...
* [💻 Code Examples](javascript/code-examples/README.md)
  * [Browser](javascript/code-examples/browser/README.md)
    * [⬆ Browser-Upload](javascript/code-examples/browser/browser.md)
    * [🔐 Browser Encryption Upload](javascript/code-examples/browser/browser-with-encryption.md)
    * [🔐 Browser Decrypt File](javascript/code-examples/browser/decrypt-file.md)
    * [🤝 Share Private File](javascript/code-examples/browser/share-file.md)
  * [NodeJS Backend](javascript/code-examples/nodejs-backend/README.md)
    * [⬆ NodeJS Upload](javascript/code-examples/nodejs-backend/nodejs.md)
    * [🔐 NodeJS Encryption](javascript/code-examples/nodejs-backend/nodejs-encrypt.md)
    * [🔐 NodeJS Decrypt File](javascript/code-examples/nodejs-backend/nodejs-decrypt-file.md)
    * [🔑 Apply Access Control](javascript/code-examples/nodejs-backend/access-control.md)
